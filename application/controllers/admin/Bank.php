...
class Bank extends CI_Controller
{
	...
	{
		$data["page_title"] = "Manage Payment Account";
	...
	{
		$data["page_title"] = "Add Payment Account";

		$this->form_validation->set_rules('name', 'Name Bank', 'required');
		$this->form_validation->set_rules('number', 'Number', 'required');
		$this->form_validation->set_rules('holder', 'Name Owner', 'required');
