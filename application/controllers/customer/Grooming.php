...
class Grooming extends CI_Controller
{
	...
	{
		$data["page_title"] = "Grooming Registration";
	...
	{
		$this->form_validation->set_rules("customer_name", "Name Customer", "required");
		$this->form_validation->set_rules("customer_phone", "Phone Customer", "required");
		$this->form_validation->set_rules("customer_address", "Address Customer", "required");
		$this->form_validation->set_rules("pet_type", "Type pet", "required");
	}
}
