			...
			<div class="main-content">
				...
				<section class="section">
					<div class="section-header d-flex justify-content-between">
						<h1><?= $page_title; ?></h1>
						<a href="javascript:void(0)" class="btn btn-primary btn-lg showCreateModal" onclick="addCategory()">add category</a>
					</div>
					<!-- alert flashdata -->
			...
			<div class="modal-content">
				<form action="#" id="form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="name">Slug category</label>
						...
						<div class="form-group">
							<label for="image" id="label-photo">Image category</label>
	...
	<script>
		...
		$(document).ready(function() {
			...
			table = $('#tableCategories').DataTable({
				...
				"ajax": {
					"url": "<?= base_url('manage-category/ajaxlist') ?>",
					"type": "POST"
				},
		...
		function editCategory(id) {
			...
			// load data from ajax
			$.ajax({
				url: "<?= base_url('manage-category/ajaxedit') ?>/" + id,
				type: "GET",
				dataType: "JSON",
				success: function(data) {
					...
					$('#modal_form').modal('show'); // show bootstrap modal
					$('.modal-title').text('Ubah category'); // Set Title to Bootstrap modal title
		...
		function save() {
			...
			if (saveMethod == 'add') {
				url = "<?= base_url('manage-category/ajaxadd') ?>";
			} else {
				url = "<?= base_url('manage-category/ajaxupdate') ?>";
			}
		...
		function deleteCategory(id) {
			swal({
				...
				if (result) {
					$.ajax({
						url: "<?= base_url('manage-category/ajaxdelete') ?>/" + id,
						type: "POST",
						dataType: "JSON",
						success: function(data) {
