                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7 mx-auto">
                                            <form action="<?= base_url("manage-customer/ubah/" . $customer["customer_id"]) ?>" method="post" enctype="multipart/form-data">
                                                <!-- id customer -->
                                                <input type="hidden" name="customer_id" value="<?= $customer["customer_id"]; ?>">
                                                <div class="form-group">
                                                    <label for="name" class="font-weight-bold">Name Customer</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="is_active">Status User Profile</label>
