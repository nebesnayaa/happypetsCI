...
<body>
            ...
            <div class="main-content">
                ...
                <section class="section">
                    <div class="section-header d-flex justify-content-between">
                        <h1><?= $page_title; ?></h1>
                        <a href="javascript:void(0)" class="btn btn-primary btn-lg showCreateModal" onclick="addPackage()">add Package grooming</a>
                    </div>
                    <!-- alert flashdata -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="tablePackages" width="100%">
                                            <thead>
                                                <tr>
                                                    <th width="50">No. </th>
                                                    <th width="250">Name Paket</th>
                                                    <th width="250">Slug</th>
                                                    <th>Deskripsi Paket</th>
                                                    <th width="150">Tarif Cat</th>
                                                    <th width="150">Tarif Dog</th>
            ...
            <div class="modal-content">
                <form action="#" id="form">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalLabel">add Package grooming</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name">Name Paket</label>
                        ...
                        <div class="form-group">
                            <label for="cost_for_cat">Cost Pelayanan untuk Cat</label>
                            <input type="number" name="cost_for_cat" id="cost_for_cat" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="cost_for_dog">Cost Pelayanan untuk Dog</label>
    ...
    <script>
        ...
        function addPackage() {
            ...
            $('.modal-title').text('add Package grooming'); // Set Title to Bootstrap modal title
        ...
        function editPackage(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#modal_form').modal('show'); // show bootstrap modal
                    $('.modal-title').text('Ubah Package grooming'); // Set Title to Bootstrap modal title
                ...
                success: function(data) {
                    ...
                    if (data.status) //if success close modal and reload ajax table
                    {
                        ...
                        if (saveMethod == 'add') {
                            ...
                            swal({
                                title: 'Success',
                                text: 'category Success diaddkan',
                                icon: 'success'
                            });
                        } else {
                            $('#modal_form').modal('hide');
                        ...
                        swal({
                            title: 'Fail',
                            text: 'Please complete all required forms',
                            icon: 'error'
                        });
                    }
        ...
        function deletePackage(id) {
            swal({
                title: "Anda yakin?",
                text: "Data category akan didelete!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((result) => {
