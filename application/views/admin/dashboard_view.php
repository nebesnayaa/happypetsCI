							...
							<div class="card border-left-danger shadow h-80 py-2 bg-primary">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-md font-weight-bold text-white text-uppercase mb-1">Quantity User</div>
						...
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="card border-left-danger shadow h-80 py-2 bg-warning">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-md font-weight-bold text-white text-uppercase mb-1">Quantity product</div>
						...
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="card border-left-danger shadow h-80 py-2 bg-danger">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-md font-weight-bold text-white text-uppercase mb-1">Quantity Grooming</div>
						...
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="card border-left-danger shadow h-80 py-2 bg-success">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-md font-weight-bold text-white text-uppercase mb-1">Quantity Transactions</div>
