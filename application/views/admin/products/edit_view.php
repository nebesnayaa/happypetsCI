								...
								<div class="card-body">
									<div class="row">
										<div class="col-7 mx-auto">
											<form action="<?= base_url("manage-product/ubah/" . $product["item_id"]) ?>" method="post" enctype="multipart/form-data">
												<div class="form-group">
													<label for="name" class="font-weight-bold">Name product</label>
												...
												<div class="form-group">
													<label for="stock">Stok product</label>
												...
												<div class="form-group">
													<label for="price">Price Jual</label>
