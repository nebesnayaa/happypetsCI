								...
								<div class="card-body" style="background-color: #EDEADE;">
									...
									<form action="<?= base_url("customer/profile/update-profile") ?>" method="post" enctype="multipart/form-data">
										<div class="form-group row">
											<label for="email" class="col-sm-2 col-form-label">E-mail your</label>
											<div class="col-sm-10">
												...
												<small class="text-muted">Contact the administrator to change the email</small>
											</div>
										</div>
										<div class="form-group row">
											<label for="name" class="col-sm-2 col-form-label">Name your</label>
											<div class="col-sm-10">
										...
										<div class="form-group row">
											<label for="address" class="col-sm-2 col-form-label">Address your</label>
											<div class="col-sm-10">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												...
												<small class="text-muted">Please leave this field blank if the current information meets your needs</small>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-8">
												...
												<a href="<?= base_url("home"); ?>" class="btn btn-warning">Cancel</a>
											</div>
										</div>
									</form>
								</div>
