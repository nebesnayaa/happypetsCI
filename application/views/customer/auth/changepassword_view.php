								...
								<div class="p-5">
									...
									<form class="user" action="<?= base_url("customer/auth/changepassword") ?>" method="POST">
										<div class="form-group">
											<input type="password" class="form-control form-control-user <?= form_error('new_password') ? 'is-invalid' : ''; ?>" id="new_password" name="new_password" placeholder="New password..." autofocus>
