								...
								<div class="p-5">
									...
									<form class="user" action="<?= base_url("login") ?>" method="POST">
										<div class="form-group">
											<input type="text" class="form-control form-control-user <?= form_error('email') ? 'is-invalid' : ''; ?>" id="email" name="email" placeholder="E-mail" autofocus>
									...
									<hr>
									<div class="text-center">
										<a class="small" href="<?= base_url("customer/auth/forgotpassword") ?>">Back to Login?</a>
									</div>
									<div class="text-center">
										<a class="small" href="<?= base_url("register") ?>">Sign up for a new account!</a>
									</div>
								</div>
							</div>
						</div>
