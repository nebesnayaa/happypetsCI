	...
	<div class="container py-5">
		...
		<div class="row">
			<div class="col">
				<div class="title-page">
					...
					<p class="text-muted">Find the products you're looking for by category.</p>
				</div>
			</div>
		</div>
		</div>
		...
		<?php if ($categories) : ?>
			<div class="row">
				<?php foreach ($categories as $category) : ?>
					<div class="col-6">
						<a href="<?= base_url("category/" . $category["category_id"]) ?>" class="text-decoration-none text-dark">
		...
		<?php else : ?>
			<div class="alert alert-danger">
				Sorry, no product available yet.
			</div>
		<?php endif; ?>
